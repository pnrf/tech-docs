...
В Nextra все файлы с расширением `.mdx`, расположенные в директории `pages/`, отрисовываются на странице сайта при помощи [MDX](https://mdxjs.com/about).
...
При этом кроме базового функционала MDX в Nextra также поддерживаются некоторые продвинутые возможности Markdown. Они реализованы встроенным функционалом, о котором вы можете узнать в разделе ["Компоненты"](./build-ins).
