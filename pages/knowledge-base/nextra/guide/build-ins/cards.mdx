...
<Callout type="warning" emoji="⚠️">
  Иногда реализация, предложенная в [документации Nextra](https://nextra.site/docs/guide/built-ins/cards), не работает. Возникает сообщение об ошибке. В этом случае возможно вставить svg код иконки непосредственно в компонент `Card`, а не передавать ссылку на импортируемый svg файл.
</Callout>
