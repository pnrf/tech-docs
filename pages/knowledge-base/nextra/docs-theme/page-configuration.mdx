...
В Nextra структура сайта и страниц может быть настроена с помощью файлов `_meta.json`. В теме для документации доступно несколько настроек для дополнительной конфигурации. Они прежде всего влияют на общий вид темы, а также на отображение панели навигации и боковой панели.
