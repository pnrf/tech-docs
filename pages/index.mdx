...
<figure style={{display: "flex", flexDirection: "column"}}>
	...
	<figcaption style={{margin: "0 0 0 auto", fontSize: "12px", fontStyle: "italic"}}>Кадр из [м/ф "Черепашки-ниндзя: Погром мутантов" (2023)](https://www.kinopoisk.ru/film/1178862/) </figcaption>
</figure>
