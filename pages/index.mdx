...
![Картинка](../images/banner-2.png)

## Всем привет!

Меня зовут Юрий. Я технический писатель.

На этом сайте собрал краткую информацию о себе, объединил [портфолио](./portfolio/intro.mdx), [базу знаний](./knowledge-base/intro.mdx) и [блог](./blog/blog.mdx), чтобы показать свои умения и навыки на реальных примерах. Это позволяет мне эффективнее общаться с рекрутерами и тимлидами в процессе поиска работы.

## Чем занимаюсь

Работаю в ИТ с 2023 года. Составляю техническую и юридическую документацию по программным продуктам, пишу тексты для интерфейсов и создаю контент для корпоративных баз знаний. Изучаю ГОСТ 19 и 34 серий. Общаюсь с профессиональным сообществом в Телеграм-чате ["Технические писатели" ↗](https://t.me/technicalwriters).
