...
<div style={{border: "1px solid white", borderRadius: "18px"}}>
...
На этом сайте собрал краткую информацию о себе. Объединил [портфолио](./portfolio/intro.mdx), [базу знаний](./knowledge-base/intro.mdx) и [блог](./blog/blog.mdx), чтобы эффективнее общаться с рекрутерами и тимлидами в процессе поиска работы, чтобы показать им свои умения и навыки на реальных примерах.

## Чем занимаюсь

Работаю в ИТ с 2023 года. Составляю техническую документацию по программным продуктам, пишу тексты для интерфейсов и создаю контент для баз знаний. Общаюсь с профессиональным сообществом в Телеграм-чате ["Технические писатели" ↗](https://t.me/technicalwriters).
...
До этого 20 лет проработал юристом по сделкам и бизнес-процессам. Составлял договорную и организационно-распорядительную документацию. Защищал интересы бизнеса в судах и госорганах.
...
Если у вас возникли вопросы или предложения о работе, пожалуйста, напишите мне. Я доступен онлайн для всех регионов России.
