...
<figure style={{display: "flex", flexDirection: "column"}}>
	<img style={{margin: "0 auto", border: "1px solid rgb(128, 128, 128)", borderRadius: "10px", overflow: "hidden"}} src="https://github.com/pnrf/tech-docs/blob/main/images/yup_01-1-2.PNG?raw=true" alt="Сплинтер. Кадр из мультфильма Черепашки-ниндзя" />
	<figcaption style={{margin: "0 0 0 auto", fontSize: "12px", fontStyle: "italic"}}>Учитель Сплинтер из [м/ф "Черепашки-ниндзя: Погром мутантов" (2023)](https://www.kinopoisk.ru/film/1178862/) </figcaption>
</figure>
...
На этом сайте собрал краткую информацию о себе, объединил [портфолио](./portfolio/), [базу знаний](./knowledge-base/intro.mdx) и [блог](./blog/publications.mdx), чтобы показать свои умения и навыки на реальных примерах. Это позволяет мне эффективнее общаться с рекрутерами и тимлидами в процессе поиска работы.
...
До этого 20 лет отработал юристом по сделкам и бизнес-процессам. Составлял договорную и организационно-распорядительную документацию. Защищал интересы бизнеса в судах и госорганах.
